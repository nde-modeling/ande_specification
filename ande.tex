...
\begin{AndeMetadata}{ande\_array}{0.2.0}{}
  ...
  \AndeMetadataLine{ande\_array-ampl\_units}{String}{Should contain}{
    A string representing the units of the coordinate axis corresponding to the numbers stored in the array.  If missing, then the units are interpreted as a default unit of ``Volts''. 
  }
  ...
  \AndeMetadataLine{ande\_array-axis<j>\_inival}{Double}{Should contain}{
  ...
  \AndeMetadataLine{ande\_array-axis<j>\_inival-units}{String}{Should contain}{
    A string representing the units for {\tt ande\_array-axis<j>\_inival}. This and {\tt ande\_array-axis<j>\_step-units} must be specified (or not specified) as a matching pair. If missing, the units are interpreted as ``seconds''.
  }
  \AndeMetadataLine{ande\_array-axis<j>\_step}{Double}{Should contain}{
  ...
  \AndeMetadataLine{ande\_array-axis<j>\_step-units}{String}{Should contain}{
    A string representing the units for {\tt ande\_array-axis<j>\_step}. This and {\tt ande\_array-axis<j>\_inival-units} must be specified (or not specified) as a matching pair. If missing, the units are interpreted as ``seconds''.
  }
\end{AndeMetadata}

\section Discussion Topics
\begin{itemize}
\item scaling/probe attenuation
\item ordering within a group
\end{itemize}
\end{document}
