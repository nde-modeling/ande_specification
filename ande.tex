...
\begin{AndeClass}{ande\_recording}{0.3.0-groupedarray}{}
...
\newcommand{\AndeArrayElements}{
    ...
    \AndeElementLine{ande\_array-array-<i>}{Dataset}{Array}{Must contain}{An HDF5 dataset containing the data for the array corresponding to index i.  Indices start from zero. The data should be contiguous and stored as a multidimensional HDF5 array with indices given in reverse order (recall HDF5 stores in C order whereas this specification defines data stored in Fortran order). 
...
\begin{AndeClass}{ande\_array}{0.3.0-groupedarray}{ande\_recording}
